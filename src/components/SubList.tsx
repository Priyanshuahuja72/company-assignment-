      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        {data.sub_departments.length > 0 && (
          <div onClick={handleExpandToggle} style={{ cursor: 'pointer', marginLeft: 'auto' }}>
            {/* Appling the functionality into the checkbox */}
...
const SubList: React.FC = () => {
  ...
  return (
    <div style={{width: "40%" , margin: "40px auto 280px auto"}}>
